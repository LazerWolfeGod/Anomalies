...
const tile_key = {
	...
	"Meadow":{"Base":[Vector2i(4,0),2],"Structures":{"Farm":[[Vector2i(3,2),2],[Vector2i(4,2),2],[Vector2i(5,2),2]],"Corruption":[[Vector2i(5,0),2]],"Wind Turbine":[[Vector2i(0,4),2],[Vector2i(1,4),2],[Vector2i(2,4),2]]}},
	"Core":{"Base":[Vector2i(3,1),2],"Structures":{"Core":[[Vector2i(3,1),2],[Vector2i(3,0),1]],"Corrupt Core":[[Vector2i(2,0),1]]}},
