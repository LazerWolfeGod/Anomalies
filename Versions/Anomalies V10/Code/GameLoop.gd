...
var structures = {
	...
	"Corruption":[{"Cost":{"Oxygen":4},"Upkeep":{"Blood_Pressure":1},"Output":{"Oxygen":1,"Max_Blood_Pressure":3,"Max_Oxygen":1}},
				{"Cost":{"Oxygen":8},"Upkeep":{"Blood_Pressure":3},"Output":{"Oxygen":2,"Max_Blood_Pressure":10,"Max_Oxygen":2}},
				{"Cost":{"Oxygen":20},"Upkeep":{"Blood_Pressure":8},"Output":{"Oxygen":4,"Max_Blood_Pressure":20,"Max_Oxygen":4}}]
}
const struct_owners = {
