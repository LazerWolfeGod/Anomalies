...
const tile_key = {
	...
	"Forest":{"Base":[Vector2i(0,0),2],"Structures":{"Lumber Mill":[[Vector2i(0,2),2],[Vector2i(1,2),2],[Vector2i(2,2),2]],"Farm":[[Vector2i(0,3),2],[Vector2i(1,3),2],[Vector2i(2,3),2]],"Corruption":[[Vector2i(3,3),2],[Vector2i(4,3),2],[Vector2i(5,3),2],[Vector2i(5,0),2]]}},
	"Rock":{"Base":[Vector2i(1,0),2],"Structures":{"Mines":[[Vector2i(0,1),2],[Vector2i(1,1),2],[Vector2i(2,1),2]],"Corruption":[[Vector2i(1,0),1],[Vector2i(1,0),1],[Vector2i(1,0),1],[Vector2i(1,0),1]]}},
	"City":{"Base":[Vector2i(2,0),2],"Structures":{"Corruption":[[Vector2i(3,3),2],[Vector2i(4,3),2],[Vector2i(5,3),2],[Vector2i(5,0),2]]}},
	"Water":{"Base":[Vector2i(3,0),2],"Structures":{}},
	"Meadow":{"Base":[Vector2i(4,0),2],"Structures":{"Farm":[[Vector2i(3,2),2],[Vector2i(4,2),2],[Vector2i(5,2),2]],"Corruption":[[Vector2i(3,3),2],[Vector2i(4,3),2],[Vector2i(5,3),2],[Vector2i(5,0),2]],"Wind Turbine":[[Vector2i(0,4),2],[Vector2i(1,4),2],[Vector2i(2,4),2]]}},
	"Core":{"Base":[Vector2i(3,1),2],"Structures":{"Core":[[Vector2i(3,1),2],[Vector2i(3,0),1]],"Corrupt Core":[[Vector2i(2,0),1],[Vector2i(2,0),1],[Vector2i(2,0),1],[Vector2i(2,0),1]]}},
...
func refresh_tile_atlas_data(tiledata):
	...
	if not(tiledata["Structure"] is String):
		if tiledata["Structure"]["Name"] in tile_key[tiledata["Tile"]]["Structures"]:
			texturename+="_"+tiledata["Structure"]["Name"]+"_"+str(tiledata["Structure"]["Level"]-1)
			#print(tiledata["Tile"],tiledata["Structure"]["Name"],tiledata["Structure"]["Level"]-1)
			dat = tile_key[tiledata["Tile"]]["Structures"][tiledata["Structure"]["Name"]][tiledata["Structure"]["Level"]-1]
