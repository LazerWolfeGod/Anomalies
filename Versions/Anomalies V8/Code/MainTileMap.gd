...
const tile_key = {
	...
	"CorruptRock":{"Base":[Vector2i(1,0),1],"Structures":{}},
	"CorruptCore":{"Base":[Vector2i(2,0),1],"Structures":{}},
	
	"Forest":{"Base":[Vector2i(0,0),2],"Structures":{"Lumber Mill":[[Vector2i(0,2),2],[Vector2i(1,2),2],[Vector2i(2,2),2]]}},
	"Rock":{"Base":[Vector2i(1,0),2],"Structures":{"Mines":[[Vector2i(0,1),2],[Vector2i(1,1),2],[Vector2i(2,1),2]]}},
	"City":{"Base":[Vector2i(2,0),2],"Structures":{}},
	"Water":{"Base":[Vector2i(3,0),2],"Structures":{}},
	"Meadow":{"Base":[Vector2i(4,0),2],"Structures":{}},
	"CorruptTile":{"Base":[Vector2i(5,0),2],"Structures":{}},
	"Core":{"Base":[Vector2i(3,1),2],"Structures":{"Core":[[Vector2i(3,1),2],[Vector2i(3,0),1]]}},
